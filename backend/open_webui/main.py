...
from open_webui.config import (
    ...
    # ADDED by RED
    CUSTOMTTS_OPENAPI_BASE_URL,
    CUSTOMTTS_OPENAPI_KEY,
...
# Added by RED: Assign custom TTS config to the app state config instance
app.state.config.CUSTOMTTS_OPENAPI_BASE_URL = CUSTOMTTS_OPENAPI_BASE_URL
app.state.config.CUSTOMTTS_OPENAPI_KEY = CUSTOMTTS_OPENAPI_KEY
